/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 66ad900f182e3ca2fd4d99a8f1b43c9d)
// Runtime types generated with workerd@1.20260903.1 2026-09-06 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	MAC_ORIGIN_URL: string;
	MAC_ACCESS_CLIENT_ID: string;
	MAC_ACCESS_CLIENT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAC_ORIGIN_URL" | "MAC_ACCESS_CLIENT_ID" | "MAC_ACCESS_CLIENT_SECRET" | "STREAM_TICKET_SECRET">> {}
}
